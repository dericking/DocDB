...
sub JournalTable (;$) {
  ...
  foreach my $ID (@JournalIDs) {
    print "<tr>\n";
    print "<td>".SmartHTML({-text => $Journals{$ID}{Name}},)."</td>\n";
    print "<td>".SmartHTML({-text => $Journals{$ID}{Abbreviation}},)."</td>\n";
    print "<td>".SmartHTML({-text => $Journals{$ID}{Acronym}},)."</td>\n";
    print "<td>".SmartHTML({-text => $Journals{$ID}{Publisher}},)."</td>\n";
    print "<td>".SmartHTML({-text => $Journals{$ID}{URL}, -makeURLs => $TRUE},)."</td>\n";
    print "</tr>\n";
  }
  print "</table>\n";
}
