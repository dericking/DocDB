...
sub PersonalAccountLink () {
  my $PersonalAccountLink = "<a href=\"$EmailLogin\" class=\"w3-text-teal\">Your Account</a>";
  if ($UserValidation eq "shibboleth" || $UserValidation eq "FNALSSO") {
    $PersonalAccountLink = "<a href=\"$SelectEmailPrefs\" class=\"w3-text-teal\">Your Account</a>";
